    ...
    return (
        <div className="space-y-6 pb-24 animate-fade-in">
            <div className="mb-4">
                ...
                <p className="text-slate-500 mt-1 text-sm">Track your journey to mastery</p>
            </div>

            {/* Level Card */}
            <div className="bg-slate-900 rounded-2xl p-6 text-white shadow-lift relative overflow-hidden">
            ...
            <div className="grid grid-cols-3 gap-3">
                <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-soft flex items-center gap-3">
                    ...
                    <div>
                        <div className="text-lg font-display font-bold text-slate-900">{progress.xp}</div>
                        <div className="text-[10px] text-slate-400 font-bold uppercase">XP</div>
                    </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-soft flex items-center gap-3">
                    ...
                    <div>
                        <div className="text-lg font-display font-bold text-slate-900">{progress.streak.current}</div>
                ...
                <div className="bg-white p-4 rounded-2xl border border-slate-200/80 shadow-soft flex items-center gap-3">
                    ...
                    <div>
                        <div className="text-lg font-display font-bold text-slate-900">{toeicScore}</div>
                        <div className="text-[10px] text-slate-400 font-bold uppercase">TOEIC</div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <section className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-soft">
                    <h3 className="text-base font-display font-bold text-slate-900 mb-5 flex items-center gap-2">
                        <BookIcon size={18} className="text-brand-600" /> Grammar Mastery
                    </h3>

                    <div className="flex items-center gap-5 mb-5">
                        <div className="flex-1">
                            <div className="text-3xl font-display font-bold text-slate-900 mb-0.5">{Math.round((grammarStats.completed / 145) * 100)}%</div>
                            <div className="text-xs text-slate-500">Course Completion</div>
                        </div>
                    ...
                    <div className="space-y-3">
                        <div>
                            ...
                            <div className="w-full bg-slate-100 rounded-full h-1.5">
                                <div className="bg-brand-500 h-1.5 rounded-full transition-all duration-500" style={{ width: `${(grammarStats.completed / 145) * 100}%` }}></div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="w-full bg-slate-100 rounded-full h-1.5">
                                <div className="bg-emerald-500 h-1.5 rounded-full transition-all duration-500" style={{ width: `${grammarStats.averageScore}%` }}></div>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-soft">
                    <h3 className="text-base font-display font-bold text-slate-900 mb-5 flex items-center gap-2">
                        <PenIcon size={18} className="text-brand-600" /> Vocabulary
                    </h3>

                    <div className="grid grid-cols-2 gap-3 mb-5">
                        <div className="bg-slate-50 p-3 rounded-xl text-center">
                            <div className="text-xl font-display font-bold text-slate-900">{progress.vocabulary?.totalLearned || 0}</div>
                            <div className="text-[10px] font-bold text-slate-400 uppercase">Words Learned</div>
                        </div>
                        <div className="bg-emerald-50 p-3 rounded-xl text-center">
                            <div className="text-xl font-display font-bold text-emerald-600">{progress.vocabulary?.totalMastered || 0}</div>
                            <div className="text-[10px] font-bold text-emerald-600/60 uppercase">Mastered</div>
                        </div>
                    </div>

                    <div className="space-y-2">
                        <div className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-2">Box Distribution</div>
                        {[5, 4, 3, 2, 1].map(box => {
                            ...
                            return (
                                <div key={box} className="flex items-center gap-3 text-sm">
                                    <div className="w-10 font-medium text-slate-500 text-xs">Box {box}</div>
                                    ...
                                    <div className="w-6 text-right font-bold text-slate-700 text-xs">{count}</div>
                                </div>
                            )
                        })}
                    </div>
